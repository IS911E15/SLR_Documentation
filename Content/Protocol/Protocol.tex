...
Given the previously stated purpose, this search needs to be broad enough to give an overview of Lean Software Development, without including articles of standard Lean (i.e. Lean Manufacturing) or other Development Methodologies. \Alexander{What is Lean Software Development? Development Methodology? Buisiness Strategy? Toolkit?}
...
\Alexander{Would Lean Software not cover all the articles found in the left lane? And the same for the right side with Lean IS?}
\Dan{We should consider indicating that, for exanple, ``Lean'' is one search term and ``Software Development'' is another.}
\section{Databases}
